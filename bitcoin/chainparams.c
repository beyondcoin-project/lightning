...
const struct chainparams networks[] = {
    ...
    {.network_name = "testnet",
     ...
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_TEST_PUBLIC,
			   .bip32_privkey_version = BIP32_VER_TEST_PRIVATE},
     .is_elements = false},
    {.network_name = "beyondcoin",
     .bip173_name = "bynd",
     .bip70_name = "main",
     .genesis_blockhash = {{{.u.u8 = {0x0a, 0x9e, 0x3b, 0x5f, 0xce, 0x3a, 0xee,
                      0x6e, 0x04, 0xf0, 0x6d, 0xfd, 0x6a, 0xd3,
                      0x80, 0xa6, 0xc0, 0xf9, 0xd8, 0x42, 0x0f,
                      0x53, 0xa4, 0xca, 0x97, 0x84, 0x57, 0x56,
				      0xee, 0x5d, 0x56, 0xe7}}}},
     .rpc_port = 10332,
     .cli = "beyondcoin-cli",
     .cli_args = NULL,
     ...
     .when_lightning_became_cool = 87500,
     .p2pkh_version = 48,
     .p2sh_version = 50,
     .testnet = false,
     .fee_asset_tag = NULL,
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_MAIN_PUBLIC,
			   .bip32_privkey_version = BIP32_VER_MAIN_PRIVATE},
     .is_elements = false},
    {.network_name = "beyondcoin-testnet",
     .bip173_name = "tbynd",
     .bip70_name = "test",
